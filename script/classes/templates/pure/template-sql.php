    ...
    <div class="panel panel-default">
        ...
        <div class="page-title clearfix panel-heading pdocrud-table-heading">
            ...
            <?php if ($settings["savebtn"]) { ?>
                <div class="btn-group pull-right">
                    <a title="<?php echo $lang["save"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-save btn btn-success" href="javascript:;" data-rendertype="SQL" data-action="save_crud_table_data" data-obj-key="<?php echo $objKey; ?>">
                    ...
                    <div class="row pdocrud-search">
                        ...
                        <?php if ($settings["deleteMultipleBtn"]) { ?>
                            <div class="col-md-1 col-sm-1 col-xs-1 no-padding">
                                <a title="<?php echo $lang["delete_selected"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-delete-all btn btn-danger" href="javascript:;" data-rendertype="SQL" data-action="delete_selected" data-obj-key="<?php echo $objKey; ?>">
                                        ...
                                        if (is_array($btnActions) && count($btnActions)) {
                                            ...
                                            <?php foreach ($btnActions as  $action_name => $action) { 
                                                    ...
                                                    <?php
                                                        ...
                                                        $specificActions = ["delete", "url"];

                                                        if (in_array($action_name, $specificActions)) {
                                                            switch ($action_name) {
                                                                case "delete":
                                                                    $btnClass .= "btn-danger pdocrud-actions";
                                                                    break;
                                                                case "url":
                                                                    $btnClass .= "btn-default";
                                                                    break;
                                                            }
                                                            $btnClass .= "";  // Agrega esta clase solo para los actions específicos
                                                        } else {

                                    ...
                                    <tr class="pdocrud-header-row">
                                        <?php if ($settings["numberCol"]) { ?>
                                            ...
                                            if ($columns) foreach ($columns as $colkey => $column) {
                                                ?>
                                                <?php if($column["col"] != "id_detalle_de_solicitud" && $column["col"] != "id_datos_paciente"){ ?>

                                                    <th <?php echo $column["attr"]; ?> data-col="<?=$column["col"];?>" data-action="<?php echo $column["sort"]; ?>"  data-sortkey="<?php echo $colkey; ?>" data-rendertype="SQL" class="pdocrud-actions-sorting pdocrud-<?php echo $column["sort"]; ?>">
                                ...
                                $sumrow = false;
                                    ...
                                    <tr data-id="<?=$rows[$pk]?>" id="pdocrud-row-<?php echo $rowcount; ?>" class="pdocrud-data-row">
                                        ...
                                        foreach ($rows as $col => $row) {
                                            ...
                                            if($col != "id_datos_paciente" && $col != "id_detalle_de_solicitud"){
                                                if (is_array($row)) {
                                                    ?>    

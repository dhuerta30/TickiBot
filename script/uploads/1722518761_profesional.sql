...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2024 a las 18:27:21
...
(56, 'HERNAN OSCAR', 'PEREZ ALVAREZ', NULL),
(57, 'JAINIAIA', 'MARTE SALCEDO', NULL),
(58, 'RAFAEL', 'LOGREIRA RODRIGUEZ', NULL),
(59, 'VICTORIA ALVAREZ', 'MALDONADO', NULL),
(60, 'GOMEZ', 'JUAN CARLOS', NULL),
(61, 'CAROLINA LORETO', 'CONCHA BALLESTEROS', NULL),
(62, 'NIVIA', 'RUIZ ALVAREZ', NULL),
(63, 'FERNANDA', 'ALVAREZ ROJAS', NULL),
(64, 'DANIEL', 'MORENO MIRANDA', NULL),
(65, 'CARLENY JOSE', 'CORDERO LUGO', NULL),
(66, 'MARIA ZOILA', 'GOMEZ ROJAS', NULL),
(67, 'YSIS', 'SANCHEZ GIL', NULL),
(68, 'ALEJANDRO JOSE', 'HERNANDEZ PEÑA', NULL),
(69, 'EDUARDO', 'MORALES MEZA', NULL),
(70, 'HERNAN VIVEROS', 'GUAJARDO', NULL),
(71, 'ALEJANDRO', 'RODRIGUEZ GONZALEZ', NULL),
(72, 'MACHADO CORCEGA', 'SAMARIS', NULL),
(73, 'ROBLES MERO', 'KATIUSKA ELIZABETH', NULL),
(74, 'NINO DUARTE', 'ANA YELITZA', NULL),
(75, 'LYNCH ARELLANO', 'RODRIGO ARTURO', NULL),
(76, 'CARLOS', 'AGUILERA GRANJA', NULL),
(77, 'DENISSE', 'VALLADARES GONZALEZ', NULL),
(78, 'JESUS', 'ASCANIO CARMONA', NULL);
...
--
ALTER TABLE `profesional`
  MODIFY `id_profesional` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
COMMIT;

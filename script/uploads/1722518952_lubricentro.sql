...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-07-2024 a las 18:38:46
...
(2593, 'Neumatico 145 R13 LT Ling Long ', 'litros', 10, 'Bodega 1', 5000, ''),
(2592, 'Neumatico 145 R13 Nexen 10PR ', 'demo 2', 0, 'Bodega 2', 2000, ''),
(2591, 'Neumatico 145 R13C 8PR HANKOOK', 'demo 3', 0, 'Bodega 3', 3000, ''),
(2590, 'Neumatico 145/70 R12 Ling long 69S', '', 0, '2', 4000, ''),
(2587, 'Neumatico 155 R13 Nexen 8PR', '', 3, '2', 1000, ''),
(2588, 'Neumatico 155 R12C Goodride ', '', 0, '2', 5000, ''),
(2589, 'Neumatico 155 R12 Nexen 8PR CP321', '', 2, '2', 5000, ''),
...
(64, 47, '2593', '1', '', '5000', 5000),
(66, 48, '2593', '2', '', '2000', 4000),
(67, 48, '2592', '1,3', '', '2000', 2600);
...
(3, 3, 'Productos', 'Agregar,Editar,Acciones,Busqueda,PDF'),
...
(47, 'ana', '2022-07-27', '10:28:47'),
(48, 'ana', '2024-04-05', '16:33:01');
...
--
ALTER TABLE `inventory`
  MODIFY `id_inventory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2649;

--
-- AUTO_INCREMENT de la tabla `items`
--
ALTER TABLE `items`
  MODIFY `id_items` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
